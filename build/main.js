...
Elm.Project.make = function (_elm) {
   "use strict";
   _elm.Project = _elm.Project || {};
   if (_elm.Project.values) return _elm.Project.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var viewOpenSourceLink = function (project) {
   ...
   var view = function (project) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.a,
                      _U.list([$Html$Attributes.href(project.primaryUrl),$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "color",_1: "inherit"}]))]),
                      _U.list([A2($Html.h2,
                      _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "margin",_1: "0"}]))]),
                      _U.list([$Html.text(project.name)]))]))
   ...
   var decoder = $Json$Decode.list(A6($Json$Decode.object5,
   Project,
   A2($Json$Decode._op[":="],"previewImageUrl",$Json$Decode.string),
   A2($Json$Decode._op[":="],"name",$Json$Decode.string),
   A2($Json$Decode._op[":="],"primaryUrl",$Json$Decode.string),
   A2($Json$Decode._op[":="],"description",$Json$Decode.string),
   $Json$Decode.maybe(A2($Json$Decode._op[":="],"repositoryUrl",$Json$Decode.string))));
   return _elm.Project.values = {_op: _op,decoder: decoder,view: view,Project: Project};
};
...
Elm.Sidebar.make = function (_elm) {
   ...
   _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: "240px"}
