...
var _lukewestby$elm_http_builder$HttpBuilder$RequestBuilder = F2(
	function (a, b) {
...
var _lukewestby$elm_http_builder$HttpBuilder$responseFromRaw = F2(
	function (reader, response) {
		var _p22 = reader(response.value);
		if (_p22.ctor === 'Ok') {
			return _elm_lang$core$Task$succeed(
				{data: _p22._0, status: response.status, statusText: response.statusText, headers: response.headers, url: response.url});
		} else {
			return _elm_lang$core$Task$fail(
				_lukewestby$elm_http_builder$HttpBuilder$UnexpectedPayload(_p22._0));
		}
	});
var _lukewestby$elm_http_builder$HttpBuilder$handleResponse = F3(
	function (successReader, errorReader, response) {
		var isSuccessful = (_elm_lang$core$Native_Utils.cmp(response.status, 200) > -1) && (_elm_lang$core$Native_Utils.cmp(response.status, 300) < 0);
		return isSuccessful ? A2(_lukewestby$elm_http_builder$HttpBuilder$responseFromRaw, successReader, response) : A3(
			_elm_lang$core$Basics$flip,
			_elm_lang$core$Task$andThen,
			function (_p23) {
				return _elm_lang$core$Task$fail(
					_lukewestby$elm_http_builder$HttpBuilder$BadResponse(_p23));
			},
...
var _lukewestby$elm_http_builder$HttpBuilder$send = F3(
	function (successReader, errorReader, _p24) {
		var _p25 = _p24;
		return A3(
			_elm_lang$core$Basics$flip,
			_elm_lang$core$Task$andThen,
			A2(_lukewestby$elm_http_builder$HttpBuilder$handleResponse, successReader, errorReader),
			A2(
				_elm_lang$core$Task$mapError,
				_lukewestby$elm_http_builder$HttpBuilder$promoteRawError,
				A2(_evancz$elm_http$Http$send, _p25._1, _p25._0)));
	});

var _user$project$Model_ops = _user$project$Model_ops || {};
_user$project$Model_ops['|:'] = _elm_lang$core$Json_Decode$object2(
	F2(
		function (x, y) {
			return x(y);
		}));
...
var _user$project$Model$Project = F5(
	function (a, b, c, d, e) {
		return {previewImageUrl: a, name: b, primaryUrl: c, description: d, repositoryUrl: e};
	});
var _user$project$Model$decodeProject = A2(
	...
	A2(
		...
		A2(
			...
			A2(
				...
				A2(
					_user$project$Model_ops['|:'],
					_elm_lang$core$Json_Decode$succeed(_user$project$Model$Project),
					A2(_elm_lang$core$Json_Decode_ops[':='], 'previewImageUrl', _elm_lang$core$Json_Decode$string)),
				A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string)),
			A2(_elm_lang$core$Json_Decode_ops[':='], 'primaryUrl', _elm_lang$core$Json_Decode$string)),
...
var _user$project$Model$Model = F5(
	function (a, b, c, d, e) {
		return {projects: a, isLoading: b, loadFailed: c, offset: d, limit: e};
	});

var _user$project$Cmds$projectsReader = _lukewestby$elm_http_builder$HttpBuilder$jsonReader(
	_elm_lang$core$Json_Decode$list(_user$project$Model$decodeProject));
var _user$project$Cmds$loadProjects = F2(
	function (failure, success) {
		return A3(
			_elm_lang$core$Task$perform,
			_elm_lang$core$Basics$always(failure),
			success,
			A2(
				_elm_lang$core$Task$map,
				function (_) {
				...
				A3(
					...
					_user$project$Cmds$projectsReader,
					_lukewestby$elm_http_builder$HttpBuilder$stringReader,
					_lukewestby$elm_http_builder$HttpBuilder$get('data/projects.json'))));
	});
var _user$project$Cmds$notifyOffsetChangedRaw = _elm_lang$core$Native_Platform.outgoingPort(
	'notifyOffsetChangedRaw',
	function (v) {
		return null;
	});
var _user$project$Cmds$notifyOffsetChanged = _user$project$Cmds$notifyOffsetChangedRaw(
	{ctor: '_Tuple0'});
...
var _user$project$Update$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'Prev':
				return (_elm_lang$core$Native_Utils.cmp(model.offset - model.limit, 0) > -1) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{offset: model.offset - model.limit}),
					_1: _user$project$Cmds$notifyOffsetChanged
				} : {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'Next':
				return (_elm_lang$core$Native_Utils.cmp(
					model.offset + model.limit,
					_elm_lang$core$List$length(model.projects)) < 0) ? {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{offset: model.offset + model.limit}),
			...
			case 'LoadProjectsSuccess':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{projects: _p0._0, isLoading: false}),
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{loadFailed: true, isLoading: false}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Update$LoadProjectsError = {ctor: 'LoadProjectsError'};
var _user$project$Update$LoadProjectsSuccess = function (a) {
	return {ctor: 'LoadProjectsSuccess', _0: a};
};
var _user$project$Update$initialize = A2(_user$project$Cmds$loadProjects, _user$project$Update$LoadProjectsError, _user$project$Update$LoadProjectsSuccess);
var _user$project$Update$Next = {ctor: 'Next'};
var _user$project$Update$Prev = {ctor: 'Prev'};
...
var _user$project$View$viewSidebar = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					{ctor: '_Tuple2', _0: 'width', _1: '240px'},
		...
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$src('assets/logo.svg')
						]),
					_elm_lang$core$Native_List.fromArray(
						[]))
				])),
						...
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[
											{ctor: '_Tuple2', _0: 'color', _1: '#999999'}
										]))
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('builtwith')
								])),
							A2(
							_elm_lang$html$Html$span,
							_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Submit a project')
						])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									{ctor: '_Tuple2', _0: 'text-align', _1: 'justfied'}
								]))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('Submit a pull request or post an issue to ')
								])),
							A2(
							_elm_lang$html$Html$a,
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$href('https://github.com/elm-community/builtwithelm')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('the Github repo')
								])),
							A2(
							_elm_lang$html$Html$span,
							_elm_lang$core$Native_List.fromArray(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('. Please include a screenshot and ensure it is ')
								])),
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text('1000px x 800px')
								])),
							A2(
							_elm_lang$html$Html$span,
							_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Built by ')
						])),
					A2(
					_elm_lang$html$Html$a,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$href('https://twitter.com/luke_dot_js')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Luke Westby')
						])),
					A2(
					_elm_lang$html$Html$span,
					_elm_lang$core$Native_List.fromArray(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$href('https://github.com/elm-community/builtwithelm/graphs/contributors')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('the amazing Elm community.')
						]))
				]))
		]));
var _user$project$View$viewOpenSourceLink = function (project) {
	var _p0 = project.repositoryUrl;
	if (_p0.ctor === 'Just') {
		return A2(
			_elm_lang$html$Html$a,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$src('assets/github.svg'),
							_elm_lang$html$Html_Attributes$style(
							_elm_lang$core$Native_List.fromArray(
								[
...
var _user$project$View$viewProject = function (project) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'margin', _1: '20px 0'}
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$href(project.primaryUrl),
								_elm_lang$html$Html_Attributes$style(
								_elm_lang$core$Native_List.fromArray(
									[
										{ctor: '_Tuple2', _0: 'color', _1: 'inherit'}
						...
						_user$project$View$viewOpenSourceLink(project)
					])),
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'background-image', _1: 'url(assets/screenshot_shell.svg)'},
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$src(project.previewImageUrl),
								_elm_lang$html$Html_Attributes$style(
								_elm_lang$core$Native_List.fromArray(
									[
...
var _user$project$View$viewList = function (model) {
	return model.isLoading ? _elm_lang$core$Native_List.fromArray(
		[
			A2(
			_elm_lang$html$Html$h2,
			_elm_lang$core$Native_List.fromArray(
		...
		]) : (model.loadFailed ? _elm_lang$core$Native_List.fromArray(
		[
			A2(
			_elm_lang$html$Html$h2,
			_elm_lang$core$Native_List.fromArray(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Unable to load projects')
				]))
		]) : A2(
		_elm_lang$core$List$map,
		_user$project$View$viewProject,
		A2(
			_elm_lang$core$List$take,
			model.limit,
			A2(_elm_lang$core$List$drop, model.offset, model.projects))));
};
var _user$project$View$viewPageButton = F3(
	function (msg, isDisabled, label) {
		var textColor = isDisabled ? '#e5e5e5' : '#5cb5cd';
		return A2(
...
var _user$project$View$view = function (model) {
	var disableNext = _elm_lang$core$Native_Utils.cmp(
		model.offset + model.limit,
		_elm_lang$core$List$length(model.projects)) > -1;
	var disablePrev = _elm_lang$core$Native_Utils.cmp(model.offset - model.limit, 0) < 0;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$View$viewSidebar,
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'margin-left', _1: '240px'},
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$View$viewList(model)),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A3(_user$project$View$viewPageButton, _user$project$Update$Prev, disablePrev, 'Newer'),
								A3(_user$project$View$viewPageButton, _user$project$Update$Next, disableNext, 'Older')
							]))
					]))
			]));
};
...
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _user$project$Model$model, _1: _user$project$Update$initialize},
